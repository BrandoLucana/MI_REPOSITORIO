  ...
  onNoClick() {
    switch (this.noButtonState) {
      ...
      case 2:
        ...
        // No cambiar GIFs, se queda en llorando2
      ...
      case 16:
        ...
        // Se queda en llorando2, no resetear
        this.growSiBtn('300px', '180px 300px');
        // No incrementar state para que se quede aquí o algo, pero para seguir creciendo, quizás incrementar
        this.noButtonState++;
        break;
    }
  }
